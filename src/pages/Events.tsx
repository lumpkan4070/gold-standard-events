...
import { Calendar, Clock, Users, MapPin, Phone, Mail, MessageCircle, Upload, Image as ImageIcon, QrCode, Camera, Type, ExternalLink } from "lucide-react";
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">
              Book exclusive events and order from your table at Victory Bistro Ultra Lounge
            </p>
          </div>

          <Tabs defaultValue="events" className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-8">
              <TabsTrigger value="events" className="text-base">Special Events</TabsTrigger>
              <TabsTrigger value="order" className="text-base">Order & Dine</TabsTrigger>
            </TabsList>

            <TabsContent value="events">{/* Events content will continue here */}
